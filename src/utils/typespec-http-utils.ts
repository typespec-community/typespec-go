 ...
 */
export function extractHttpMetadata(operation: Operation, program: Program): HttpOperationMetadata | null {
 ...
 */
function extractHttpParameter(name: string, prop: ModelProperty, httpOp: HttpOperation): HttpParameter | null {
