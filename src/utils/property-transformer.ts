...
export class PropertyTransformer {
   ...
   */
  static collectImportsForFields(
    fields: readonly TransformedGoField[],
   ...
   */
  static transformProperties(
    props: readonly TypeSpecModelProperty[],
  ): readonly TransformedGoField[] {
