...
import type { Program, Type, Model, Enum, Union, Namespace, Operation } from "@typespec/compiler";
 ...
 */
export function createMockProperty(name: string, type: Type, optional: boolean = false): any {
  return {
    name,
    type,
    optional,
