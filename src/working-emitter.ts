/**
 * Working Minimal Emitter Function
 * 
 * Uses proven TypeSpec patterns + simple string generation
 * Delivers working TypeSpec → Go pipeline
 */
import type { EmitContext, Type, Model, Namespace } from "@typespec/compiler";
...
class SimpleGoGenerator {
  static generateModel(model: any): string {
  ...
  static generateStruct(name: string, properties: any[]): string {
...
${fields}
  ...
  static generateField(property: any): string {
