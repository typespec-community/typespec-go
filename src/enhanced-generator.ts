...
import { 
  TYPE_SPEC_MAPPINGS,
  TypeSafeMapper 
} from "./mappers/type-safe-mapper.js";

import { 
  OptionalFieldPolicy 
} from "./policies/optional-field-policy.js";
...
export class EnhancedGoGenerator {
   ...
   */
  private generateEnhancedField(property: any): string {
   ...
   */
  private createTypeSpecType(baselineType: any): any {
   ...
   */
  private mapBaselineKindToTypeSpec(baselineKind: string): string {
    const mapping = {
      "String": "String",
      "Int32": "Int32", 
      "Int64": "Int64",
   ...
   */
  private generateBaselineField(property: any): string {
   ...
   */
  private formatField(goField: any): string {
